...
import com.boardend.boardend.payload.request.SignupRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok(new JwtResponse(jwt,
                ...
                userDetails.getCacNumber(),
                userDetails.getUsername(),
                userDetails.getEmail(),
                userDetails.getStreetAddress(),
                userDetails.getCompanyState(),
                userDetails.getRiderNumber(),
                roles));
    }
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getCompanyName(),
                signUpRequest.getCacNumber(),
                signUpRequest.getUsername(),
                signUpRequest.getEmail(),
                encoder.encode(signUpRequest.getPassword()),
                signUpRequest.getStreetAddress(),
                signUpRequest.getCompanyState(),
                signUpRequest.getRiderNumber());
